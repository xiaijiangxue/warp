            ...
            Flex::column()
                ...
                .with_child({
                    ...
                    model_flex.add_child(
                        Container::new(
                            Text::new(
                                t!("execution_profile.models_heading"),
                    ...
                    model_flex.add_child(with_standard_vertical_margin(
                        render_model_line_with_icon(
                            Icon::Lightning,
                            t!("execution_profile.base_model"),
                            base_model,
                            appearance,
                            is_any_ai_enabled,
                        ),
                    ...
                    model_flex.add_child(with_standard_vertical_margin(
                        render_model_line_with_icon(
                            Icon::Terminal,
                            t!("execution_profile.full_terminal_use"),
                            cli_agent_model,
                            appearance,
                            is_any_ai_enabled,
                        ),
                    ...
                    if FeatureFlag::LocalComputerUse.is_enabled() {
                        model_flex.add_child(with_standard_vertical_margin(
                            render_model_line_with_icon(
                                Icon::Laptop,
                                t!("execution_profile.computer_use"),
                                computer_use_model,
                                appearance,
                                is_any_ai_enabled,
                            ),
                    ...
                    Container::new({
                        let mut permissions_column = Flex::column()
                            .with_child(
                                Container::new(
                                    Text::new(
                                        t!("execution_profile.permissions_heading"),
                                        appearance.ui_font_family(),
                                        10.,
                                    )
                                    .with_color(appearance.theme().disabled_ui_text_color().into())
                            ...
                            .with_child(with_standard_vertical_margin(
                                render_action_permission_line_with_icon(
                                    Icon::Code2,
                                    t!("execution_profile.apply_code_diffs"),
                            ...
                            .with_child(with_standard_vertical_margin(
                                render_action_permission_line_with_icon(
                                    Icon::Notebook,
                                    t!("execution_profile.read_files"),
                                    &profile.read_files,
                                    appearance,
                                    is_any_ai_enabled,
                                ),
                        ...
                        permissions_column.add_child(with_standard_vertical_margin(
                            render_action_permission_line_with_icon(
                                Icon::Terminal,
                                t!("execution_profile.execute_commands"),
                        ...
                        permissions_column.add_child(with_standard_vertical_margin(
                            render_write_to_pty_permission_line_with_icon(
                                Icon::Workflow,
                                t!("execution_profile.interact_with_running_commands"),
                        ...
                        permissions_column.add_child(with_standard_vertical_margin(
                            render_ask_user_question_permission_line_with_icon(
                                Icon::MessageText,
                                t!("execution_profile.ask_questions"),
                        ...
                        permissions_column.add_child(with_standard_vertical_margin(
                            render_action_permission_line_with_icon(
                                Icon::Dataflow,
                                t!("execution_profile.call_mcp_servers"),
                        ...
                        if FeatureFlag::WebSearchUI.is_enabled() {
                            permissions_column.add_child(with_standard_vertical_margin(
                                render_bool_permission_line_with_icon(
                                    Icon::Globe,
                                    t!("execution_profile.call_web_tools"),
                        ...
                        permissions_column.add_child(with_standard_vertical_margin(
                            render_bool_permission_line_with_icon(
                                Icon::Compass,
                                t!("execution_profile.auto_sync_plans"),
...
fn render_action_permission_line_with_icon(
    ...
    let permission_text = match permission {
        ActionPermission::AgentDecides => t!("execution_profile.agent_decides"),
        ActionPermission::AlwaysAllow => t!("execution_profile.always_allow"),
        ActionPermission::AlwaysAsk => t!("execution_profile.always_ask"),
        ActionPermission::Unknown => t!("execution_profile.unknown"),
    };
...
fn render_write_to_pty_permission_line_with_icon(
    ...
    let permission_text = match permission {
        WriteToPtyPermission::AlwaysAllow => t!("execution_profile.always_allow"),
        WriteToPtyPermission::AlwaysAsk => t!("execution_profile.always_ask"),
        WriteToPtyPermission::AskOnFirstWrite => t!("execution_profile.ask_on_first_write"),
        WriteToPtyPermission::Unknown => t!("execution_profile.unknown"),
    };
    render_permission_line_with_icon(icon, label, permission_text, appearance, is_ai_enabled)
}
...
fn render_ask_user_question_permission_line_with_icon(
    ...
    let permission_text = match permission {
        AskUserQuestionPermission::Never => t!("execution_profile.never_ask"),
        AskUserQuestionPermission::AskExceptInAutoApprove | AskUserQuestionPermission::Unknown => {
            t!("execution_profile.ask_unless_auto_approve")
        }
        AskUserQuestionPermission::AlwaysAsk => t!("execution_profile.always_ask"),
    };
    render_permission_line_with_icon(icon, label, permission_text, appearance, is_ai_enabled)
}
...
fn render_bool_permission_line_with_icon(
    ...
    let permission_text = if enabled {
        t!("execution_profile.enabled")
    } else {
        t!("execution_profile.disabled")
    };
    render_permission_line_with_icon(icon, label, permission_text, appearance, is_ai_enabled)
}
