...
impl OnboardingPromptBlock {
    ...
    fn render_text(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Flex::column()
            .with_children([
                Container::new(
                    Text::new(t!("onboarding_prompt.line_one"), font_family, font_size)
                ...
                Container::new(
                    FormattedTextElement::new(
                        FormattedText::new([FormattedTextLine::Line(vec![
                            FormattedTextFragment::plain_text(t!("onboarding_prompt.line_two")),
                            FormattedTextFragment::hyperlink(
                                t!("onboarding_prompt.learn_more"),
                                LINK_DESTINATION,
                            ),
                        ])]),
                        font_size,
    ...
    fn render_confirm_skip_buttons(&self, appearance: &Appearance) -> Box<dyn Element> {
        let mut confirm_button = appearance
            ...
            .with_centered_text_label(t!("onboarding_prompt.confirm").to_string());
    ...
    fn render_existing_prompt_button_interior(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let prompt_body = if let Some((grid, size_info)) = &self.ps1_grid_info {
            ...
            Text::new_inline(
                t!("onboarding_prompt.no_existing_prompt"),
                font_family,
                font_size,
            )
            .with_color(font_color.into_solid())
        ...
        Flex::column()
            .with_child(
                Container::new(
                    Text::new_inline(t!("onboarding_prompt.shell_prompt"), font_family, font_size)
                        .with_color(font_color.into_solid())
                        .finish(),
                )
                ...
                Shrinkable::new(
                    ...
                    Align::new(
                        Flex::row()
                            .with_children([
                                Text::new_inline(
                                    t!("onboarding_prompt.look_incorrect"),
                                    font_family,
                                    font_size,
                                )
                                .with_color(
                                ...
                                appearance
                                    .ui_builder()
                                    .link(
                                        t!("onboarding_prompt.let_us_know").to_string(),
    ...
    fn render_warp_prompt_button_interior(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Flex::column()
            .with_child(
                Container::new(
                    Text::new_inline(
                        t!("onboarding_prompt.warp_prompt"),
                        font_family,
            ...
            .with_child(
                Shrinkable::new(
                    ...
                    Align::new(
                        Text::new_inline(
                            t!("onboarding_prompt.customizable_in_appearance_settings"),
                            font_family,
                            ui_font_size,
                        )
