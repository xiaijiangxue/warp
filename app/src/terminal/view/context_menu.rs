...
impl TerminalView {
    pub(super) fn ai_block_copying_menu_items(
        ...
        let mut items = vec![
            MenuItemFields::new(t!("common.copy").to_string())
                .with_on_select_action(TerminalAction::ContextMenu(
                    ContextMenuAction::CopyAIBlock { ai_block_view_id },
                ))
                .into_item(),
            MenuItemFields::new(t!("terminal_context_menu.copy_prompt").to_string())
                .with_on_select_action(TerminalAction::ContextMenu(
                    ContextMenuAction::CopyAIBlockQuery { ai_block_view_id },
                ))
                .into_item(),
            MenuItemFields::new(t!("terminal_context_menu.copy_output_markdown").to_string())
                .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if let Some(link) = hovered_link {
            match link {
                RichContentLink::Url(url) => {
                    items.push(
                        MenuItemFields::new(t!("terminal_context_menu.copy_url").to_string())
                            .with_on_select_action(TerminalAction::ContextMenu(
                ...
                RichContentLink::FilePath { absolute_path, .. } => {
                    items.push(
                        MenuItemFields::new(t!("terminal_context_menu.copy_path").to_string())
                            .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if num_requested_commands > 0 {
            items.push(
                MenuItemFields::new(t!("terminal_context_menu.copy_command").to_string())
                    .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if has_git_branch {
            items.push(
                MenuItemFields::new(t!("terminal_context_menu.copy_git_branch").to_string())
                    .with_on_select_action(TerminalAction::ContextMenu(
        ...
        items.push(
            MenuItemFields::new(t!("terminal_context_menu.save_as_prompt").to_string())
                .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if FeatureFlag::CloudConversations.is_enabled() {
            ...
            if history_model.can_conversation_be_shared(&ai_conversation_id) {
                items.push(
                    MenuItemFields::new(t!("terminal_context_menu.copy_share_link").to_string())
                        .with_on_select_action(TerminalAction::ContextMenu(
        ...
        items.push(
            MenuItemFields::new(t!("terminal_context_menu.copy_conversation_text").to_string())
                .with_on_select_action(TerminalAction::ContextMenu(
    ...
    fn copy_debugging_menu_items(
        ...
        if ChannelState::channel().is_dogfood() {
            vec![
                (
                    t!("terminal_context_menu.copy_debugging_link").to_string(),
                ...
                (
                    t!("terminal_context_menu.copy_conversation_id").to_string(),
            ...
            vec![(
                t!("terminal_context_menu.copy_debugging_id").to_string(),
    ...
    fn conversation_menu_items(
        ...
        items.push(
            MenuItemFields::new(t!("terminal_context_menu.fork").to_string())
                .with_on_select_action(TerminalAction::ContextMenu(
    ...
    pub(super) fn open_ai_block_overflow_context_menu(
        ...
        if !cfg!(target_family = "wasm") {
            ...
            if ChannelState::channel().is_dogfood() {
                menu_items.push(
                    MenuItemFields::new(t!("terminal_context_menu.fork_from_here").to_string())
                        .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if FeatureFlag::RevertToCheckpoints.is_enabled() && !is_restored {
            menu_items.push(
                MenuItemFields::new(t!("terminal_context_menu.rewind_to_before_here").to_string())
